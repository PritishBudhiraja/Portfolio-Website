...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className="bg-muted/50 py-12">
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((link, index) => (
              <motion.a
                ...
                className="group flex items-center justify-center w-11 h-11 rounded-xl bg-background hover:bg-primary/10 transition-colors duration-300 shadow-sm"
