    ...
    <section id="contact" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="border-none shadow-md hover:shadow-lg transition-shadow md:col-span-1">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+918979984894" className="text-muted-foreground hover:text-primary transition-colors">
                      +91-897-9984-894
                    </a>
                  </div>
                </div>
